...
import { Calendar, MapPin, Clock, Users, Star, Camera, Award, Music } from 'lucide-react'
  ...
  const upcomingEvents = [
    {
      ...
      description: "A day filled with athletic competitions, team spirit, and celebration of physical fitness.",
      category: "Sports",
      icon: Award,
    ...
    },
    {
      ...
      description: "Evening of Islamic poetry, nasheeds, and cultural performances.",
      category: "Cultural",
      icon: Music,
  ...
  const pastEvents = [
    {
      ...
      date: "2024-12-15",
      description: "A grand celebration showcasing student talents through various performances.",
      images: 3,
      highlights: ["Cultural Performances", "Award Ceremony", "Parent Participation"]
    },
    {
      title: "Ramadan Iftar Gathering",
      date: "2024-04-10",
      description: "Community iftar bringing together students, parents, and faculty.",
      images: 2,
    ...
    },
    {
      ...
      date: "2024-11-20",
      description: "Academic competition testing knowledge across various subjects.",
      images: 4,
    ...
    },
    {
      ...
      images: 1,
      highlights: ["Student Progress", "Parent Engagement", "Academic Planning"]
    }
  ]
        ...
        <div className="container-width">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Stay updated with our vibrant school community events, from academic competitions 
              to cultural celebrations and Islamic programs throughout the year.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-width">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Celebrating our memorable moments and achievements</p>
          </motion.div>
              ...
              >
                <div className="grid lg:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-2">{event.images} Photos Available</p>
                    <button className="btn-secondary text-sm">View Gallery</button>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="section-padding bg-gradient-to-br from-blue-50 to-white relative overflow-hidden">
        ...
        <div className="container-width">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: "Academic", icon: Star, color: "from-blue-500 to-blue-600", count: "12+" },
              { name: "Cultural", icon: Music, color: "from-purple-500 to-purple-600", count: "8+" },
              { name: "Sports", icon: Award, color: "from-green-500 to-green-600", count: "6+" },
              { name: "Islamic", icon: Users, color: "from-primary-500 to-primary-600", count: "10+" }
            ].map((category, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <p className="text-2xl font-bold gradient-text">{category.count}</p>
